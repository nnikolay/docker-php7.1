...
RUN \
    apt-get update && apt-get install -y locales --no-install-recommends && locale-gen de_DE.UTF-8
...
RUN DEBIAN_FRONTEND=noninteractive apt-get update && \
    apt-get install -y -qq php7.1-mcrypt php7.1-zip php7.1-xml php7.1-mbstring php7.1-curl php7.1-json php7.1-mysql php7.1-tokenizer php7.1-cli php7.1-soap
